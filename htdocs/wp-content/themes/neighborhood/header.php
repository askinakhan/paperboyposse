...
<html <?php language_attributes(); ?>>
	...
	<head>
		...
		<?php
			$custom_fonts = $google_font_one = $google_font_two = "";
		...
		?>
		<?php if (($body_font_option == "google") || ($headings_font_option == "google")) { ?>
		<!--// GOOGLE FONT LOADER //-->
		<script>
		...
		<?php } ?>
		<?php if (($body_font_option == "fontdeck") || ($headings_font_option == "fontdeck")) { ?>
		<!--// FONTDECK LOADER //-->
