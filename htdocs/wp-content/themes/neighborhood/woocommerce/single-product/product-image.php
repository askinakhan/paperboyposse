		...
		<ul class="slides">
				<?php
					if ( has_post_thumbnail() ) {
						...
						echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<li itemprop="image">%s<a href="%s" itemprop="image" class="woocommerce-main-image zoom" title="%s"  rel="prettyPhoto' . $gallery . '"><i class="icon-resize-full"></i></a></li>', $image_html, $image_link, $image_title ), $post->ID );	
