...
function spbTabsInitCallBack(element) {
	element.find('.spb_tabs_holder').not('.spb_initialized').each(function(index) {
		...
		add_btn.click( function(e) {
			...
			$tabs.tabs( "add", "#tabs-" + tabs_count, tab_title + '<a class="delete_tab"></a><a class="edit_tab"></a>');
			} else {
			$tabs.tabs( "add", "#tabs-" + tabs_count, tab_title + '<a class="edit_tab"></a><a class="delete_tab"></a>');			
			}
			//tab_counter++;
			//
				setTabButtons();
