<?php
	...
	*/
	...
	function sf_custom_styles() {
		...
		$footer_border_color = get_option('footer_border_color', '#999999');
		...
		echo '.bag-buttons a.checkout-button, .bag-buttons a.create-account-button, .woocommerce input.button.alt, .woocommerce .alt-button {background: '.$secondary_accent_color.'; color: '.$secondary_accent_alt_color.';}'. "\n";
		echo '.bag-buttons a:hover, .woocommerce .button.update-cart-button:hover {background: '.$accent_color.'; color: '.$accent_alt_color.';}'. "\n";
		echo '.bag-buttons a.checkout-button:hover, .woocommerce input.button.alt:hover, .woocommerce .alt-button:hover {background: '.$accent_color.'; color: '.$accent_alt_color.';}'. "\n";
		...
		echo '.woocommerce #account_details .login, .woocommerce #account_details .login h4.lined-heading span, .my-account-login-wrap .login-wrap, .my-account-login-wrap .login-wrap h4.lined-heading span {background: '.$alt_bg_color.';}'. "\n";
