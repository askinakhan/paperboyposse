...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				<th><?php _e('Product', 'kinetico'); ?></th>
				<th><?php _e('Qty', 'kinetico'); ?></th>
				<th><?php _e('Totals', 'kinetico'); ?></th>
			</tr>
		</thead>
		<tfoot>
		<?php 
	...
	<div id="payment">
		...
		<ul class="payment_methods methods">
			<?php 
				...
				if ($available_gateways) : 
					...
					echo '<p>'.__('Sorry, it seems that there are no available payment methods for your location. Please contact us if you require assistance or wish to make alternate arrangements.', 'kinetico').'</p>';
		...
		<div class="form-row">
			...
			<input type="submit" class="button alt" name="woocommerce_pay" id="place_order" value="<?php _e('Pay for order', 'kinetico'); ?>" />
