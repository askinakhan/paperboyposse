jQuery(document).ready( function($) {
	...
	$(".add_new_slide a").live("click", function() {
		...
		clone.find(".field-6").attr("name", "sliders["+cid+"][3]["+idinner+"][5]");
		clone.find(".field-7").attr("name", "sliders["+cid+"][3]["+idinner+"][6]");
		clone.find(".field-8").attr("name", "sliders["+cid+"][3]["+idinner+"][7]");
